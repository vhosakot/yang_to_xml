...
'''  % (raw_module_path,)
    ...
    def locationPrefimyVerewriteMap (self):
        ...
        """
        return self.__locationPrefimyVerewriteMap
    def setLocationPrefimyVerewriteMap (self, location_prefix_rewrite_map):
        self.__locationPrefixMap.clear()
        self.__locationPrefixMap.update(location_prefix_rewrite_map)
        return self
    def addLocationPrefimyVerewrite (self, prefix, substituent):
        ...
        self.__locationPrefimyVerewriteMap[prefix] = substituent
        return self
    def argAddLocationPrefimyVerewrite (self, prefix_rewrite):
        """Add a rewrite entry for schema locations.
        ...
        try:
            ...
            raise
        self.addLocationPrefimyVerewrite(prefix, substituent)
    __locationPrefixMap = {}
    ...
    def __init__ (self, *args, **kw):
        ...
        @keyword location_prefix_rewrite_map: Invokes L{setLocationPrefimyVerewriteMap}
        ...
        self.__locationPrefimyVerewriteMap = kw.get('location_prefix_rewrite_map', {})
        self.__schemas = []
    ...
    __OptionSetters = (
        ...
        ('location_prefix_rewrite', argAddLocationPrefimyVerewrite),
    ...
    def applyOptionValues (self, options, args=None):
        ...
        pyxb.utils.utility.SetLocationPrefimyVerewriteMap(self.locationPrefimyVerewriteMap())
    ...
    def optionParser (self, reset=False):
        ...
        if reset or (self.__optionParser is None):
            ...
            group.add_option('--location-prefix-rewrite', metavar="TEXT", type='string',
                             help=self.__stripSpaces(self.argAddLocationPrefimyVerewrite.__doc__))
    ...
    def getCommandLineArgs (self):
        ...
        for (pfx, sub) in self.locationPrefimyVerewriteMap():
