...
LocationPrefimyVerewriteMap_ = { }

def SetLocationPrefimyVerewriteMap (prefix_map):
    """Set the map that is used to by L{NormalizeLocation} to rewrite URI prefixes."""

    LocationPrefimyVerewriteMap_.clear()
    LocationPrefimyVerewriteMap_.update(prefix_map)
...
def NormalizeLocation (uri, parent_uri=None, prefix_map=None):
    ...
    L{SetLocationPrefimyVerewriteMap}.
    ...
    if prefix_map is None:
        prefix_map = LocationPrefimyVerewriteMap_
